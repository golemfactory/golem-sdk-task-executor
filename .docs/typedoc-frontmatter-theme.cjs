...
class ModifiedHugoTheme extends HugoTheme {
  ...
  onHugoPageEnd(page) {
    const yamlVars = {
      ...
      pageTitle: `${typedoc.ReflectionKind[page.model.kind]} ${this.getPageTitle(page)} - Task API Reference`,
      description: `Explore the detailed API reference documentation for the ${
        typedoc.ReflectionKind[page.model.kind]
      } ${this.getPageTitle(page)} within the Task API SDK for the Golem Network.`,
